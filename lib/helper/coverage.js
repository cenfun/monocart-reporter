...
const getV8JsSummary = (item) => {
    ...
    const flatRanges = getFlatRanges(item.functions);
 ...
 * (@input v8list: Array, testInfo, options: { watermarks: [], inline: Boolean }) -> @output v8 report
 */
