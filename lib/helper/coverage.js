...
const saveV8HtmlReport = async (testInfo, report, coverageDir) => {
    ...
    // save file html
    const reportDataStr = compress(JSON.stringify(report));
...
const generateV8Report = async (list, testInfo, options, coverageDir) => {
    ...
    await saveV8HtmlReport(testInfo, htmlReport, coverageDir);
