    ...
    const helper = {
        ...
        sendEmail: async (emailOptions) => {
            ...
            try {
                ...
                Util.logError('nodemailer is no longer a built-in dependency since version monocart-reporter@2.12.0, please run `npm install nodemailer` to use the email feature');
                return;
            }
