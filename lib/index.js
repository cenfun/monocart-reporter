...
const {
    startCoverage, stopCoverage, takeCoverage
} = require('./helper/coverage.js');
...
class Reporter {
    ...
    static merge = merge;
    static startCoverage = startCoverage;
    static stopCoverage = stopCoverage;
    static takeCoverage = takeCoverage;
