...
const findEndMapping = (allDecodedMappings, range, originalState) => {
...
const getOriginalRange = (allDecodedMappings, range, originalMap) => {
    ...
    if (startMapping.generatedOffset < range.startOffset) {
        ...
        //     console.log('===========================================================');
        //     console.log(range);
        //     console.log(range.startOffset, startMapping);
        // }
    }
    ...
    // end exclusive
    const endMapping = findEndMapping(allDecodedMappings, range, originalState);
