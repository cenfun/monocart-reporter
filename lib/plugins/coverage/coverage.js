...
const {
    initIstanbulV8List, saveIstanbulReport, saveV8ToIstanbulReport
...
const generateArtifactData = (v8list, options) => {
    ...
    if (options.toIstanbul) {
        ...
        return initIstanbulV8List(v8list, options);
    }
...
const generateGlobalCoverageReport = async (v8list, options) => {
...
const generateCoverageReport = async (dataList, reporterOptions) => {
    ...
    const report = await generateGlobalCoverageReport(v8list, options);
